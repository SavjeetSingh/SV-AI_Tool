  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            <h1 src={assets.logo} alt="logo" className='w-32 sm:w-44 cursor-pointer text-blue-500 font-extrabold text-4xl ' onClick={()=> navigate('/')}>SV-AI</h1>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © SavjeetSingh. All Right Reserved.
    </p>
</footer>
  )
}
